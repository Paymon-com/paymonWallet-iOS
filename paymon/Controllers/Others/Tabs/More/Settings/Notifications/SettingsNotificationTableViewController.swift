...
//        transactionsCell.accessoryView = switchTransactions
    ...
    func loadSettings() {
        switchWorry.setOn(User.shared.notificationWorry, animated: true)
        switchVibration.setOn(User.shared.notificationVibration, animated: true)
//        switchTransactions.setOn(User.shared.notificationTransactions, animated: true)
    }
    
    // Save all the changes, user made in the notification settings.
    func saveSettings () {
        User.shared.notificationWorry = switchWorry.isOn
        User.shared.notificationVibration = switchVibration.isOn
//        User.shared.notificationTransactions = switchTransactions.isOn
